...
export default function DownloadPage() {
    return (
        <main className="relative isolate min-h-screen overflow-hidden bg-linear-to-b from-[#03040a] via-[#04060c] to-[#010206]">
            <div className="absolute inset-x-0 -bottom-12 h-20 bg-linear-to-t from-[#010206] via-[#020308]/75 to-transparent pointer-events-none" />
